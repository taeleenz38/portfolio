  ...
  return (
    <div>
      ...
      <div className="infocard-2">
        <h3>About Me!</h3>
        <p>After receiving my Bsc in Psychology from the University of Melbourne, I decided to move to South Korea for 2 years. Having spent my youth abroad in New Zealand, China and Australia, I wanted to experience life in South Korea {`(being Korean myself, I wanted to experience the culture/life there)`} and ended up in various positions from working in retail to working as a story producer in an indie gaming company.</p>
